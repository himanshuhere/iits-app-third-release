...
$sql="update  tblclasses set ClassName=:classname,ClassNameNumeric=:classnamenumeric,Fees=:section where id=:cid ";
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- JavaEE, Android,SEO
                                                         etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Corse code in Numeric</label>
                                                        <div class="">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Fees</label>
                                                        <div class="">
                                                            <input type="number" name="section" value="<?php echo htmlentities($result->Section);?>" class="form-control" required="required" id="success">
                                                            <span class="help-block">INR</span>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
  <div class="form-group has-success">
