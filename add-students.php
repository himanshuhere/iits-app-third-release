...
$query = $dbh->prepare("SELECT Fees FROM tblclasses WHERE id=:classId");
...
$sql="INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,classId,batch,fees,paid,due,DOB,Status) VALUES(:studentname,:roolid,:studentemail,:gender,:classId,:batch,:result1,:paid1,:result1,:dob,:status)";
$query = $dbh->prepare($sql);
...
$query->bindParam(':paid1',$paid1,PDO::PARAM_STR);
$query->bindParam(':result1',$result1,PDO::PARAM_STR);
...
?>&nbsp; &nbsp; Fees-<?php echo htmlentities($result->Fees); ?></option>
<?php }} ?>
 </select>
            </div>
                  </div>
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->Batchname); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
